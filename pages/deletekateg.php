...
<div class="col-lg-8 col-md-8">
	...
	if ($_SESSION['kat_uzytkownikow'] == 1 || $_SESSION['kat_uzytkownikow'] == 2){ //To jest początek ifa
	    ...
	    $sql="DELETE FROM kat_newsow WHERE id_kat_newsow=".$id."";
	    ?>
	    <form action="" method="post" name="form1" id="form1" >
		<h1>Czy na pewno chcesz usunąć tę kategorię?</h1>
		...
		if($result){
		    ...
		    echo '<div class="notif-success"><a href="' . $krowa . 'pages/allkateg.php">Usunięto</a></div>';
		}
		else{
